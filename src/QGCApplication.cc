...
void QGCApplication::updateMessage(const QMqttMessage &msg)
{
    ...
    switch (this->commandsList.indexOf(message["instruction"].toString())){
        ...
        case 19:
            ...
            QGCApplication::goToWaypoint(w_speed, w_yaw, w_lat, w_lon, w_alt);
            state_value = 0;
            break;
        case 20:
            qCWarning(QGCApplicationLog) << "=================================================";
...
{ 
    ...
    qCWarning(QGCApplicationLog) << "link name" << _vehicle->vehicleLinkManager()->primaryLinkName().lock()->linkConfiguration()->name();
    vehicle->setUas("uas1");
    vehicle->setSn("sn1");
}
