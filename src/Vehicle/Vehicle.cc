...
void Vehicle::setNewVehicleData()
{
    ...
    if (sharedLink) {
        udpAddress = sharedLink->linkConfiguration()->name();
...
void Vehicle::goToWaypointGeneric(double w_speed,
    ...
    if(apmFirmware()) {
        ...
        if(guidedModeSupported()){
            ...
            w_lat = w_lat - (coordinate().altitude() - altitudeRelative()->rawValue());
...
void Vehicle::sendSetPositionTargetLocalNed(double vx, double vy, double vz, double yaw_rate) {
    ...
    cmd.type_mask = POSITION_TARGET_TYPEMASK_X_IGNORE |
                    POSITION_TARGET_TYPEMASK_Y_IGNORE |
                    POSITION_TARGET_TYPEMASK_Z_IGNORE |
                    POSITION_TARGET_TYPEMASK_AX_IGNORE |
                    POSITION_TARGET_TYPEMASK_AY_IGNORE |
                    POSITION_TARGET_TYPEMASK_AZ_IGNORE |
                    POSITION_TARGET_TYPEMASK_YAW_IGNORE; // Bitmask to indicate which dimensions should be ignored by the vehicle
